...
public class DownloadManager implements DTListener, PeerUpdateListener,
    ...
    /**
     * Stop the net.sourceforge.projects.bitext.tracker updates
     */
    ...
    public synchronized void updatePeerList(LinkedHashMap list) {
        ...
        System.out.println("Peer List updated from net.sourceforge.projects.bitext.tracker with " + list.size() +
                           " peers");
    }
