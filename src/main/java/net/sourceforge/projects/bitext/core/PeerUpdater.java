 ...
 * 2. trackerBT is the "net.sourceforge.projects.bitext.tracker" part, i.e. it implements a all classes needed to run
 *    a Bittorrent net.sourceforge.projects.bitext.tracker that coordinates peers exchanges. *
 *
...
package net.sourceforge.projects.bitext.core;
...
/**
 * Class providing methods to enable communication between the client and a net.sourceforge.projects.bitext.tracker.
 * Provide method to decode and parse net.sourceforge.projects.bitext.tracker response.
 *
 * @author Baptiste Dubuis
 * @version 0.1
 */
public class PeerUpdater extends Thread {
    ...
    /**
     * Returns the last interval for updates received from the net.sourceforge.projects.bitext.tracker
     * @return int
     */
    ...
    /**
     * Returns the last minimal interval for updates received from the net.sourceforge.projects.bitext.tracker
     * @return int
     */
    ...
    /**
     * Sets the interval between net.sourceforge.projects.bitext.tracker update
     * @param interval int
     */
    ...
    /**
     * Sets the mininterval between net.sourceforge.projects.bitext.tracker update
     * @param minInt int
     */
    ...
    /**
     * Update the parameters for future net.sourceforge.projects.bitext.tracker communication
     * @param dl int
     * @param ul int
     * @param event String
     */
    ...
    /**
     * Thread method that regularly contact the net.sourceforge.projects.bitext.tracker and process its response
     */
    public void run() {
        int tryNB = 0;
        byte[] b = new byte[0];
    ...
    /**
     * Process the map representing the net.sourceforge.projects.bitext.tracker response, which should contain
     * either an error message or the peers list and other information such as
     * the interval before next update, aso
     * @param m The net.sourceforge.projects.bitext.tracker response as a Map
        ...
        if (m != null) {
            if (m.containsKey("failure reason")) {
                this.fireUpdateFailed(0,
                                      "The net.sourceforge.projects.bitext.tracker returns the following error message:" +
                                      "\t'" +
    ...
    /**
     * Contact the net.sourceforge.projects.bitext.tracker according to the HTTP/HTTPS net.sourceforge.projects.bitext.tracker protocol and using
     ...
     * @param left long
     * @param event String
     * @return A Map containing the decoded net.sourceforge.projects.bitext.tracker response
     */
    public synchronized Map contactTracker(byte[] id,
        ...
        try {
            ...
            // Decode the net.sourceforge.projects.bitext.tracker bencoded response
     ...
     * the net.sourceforge.projects.bitext.tracker saying this client stops sharing the file and it also exits
     * the run method
     */
    public void end() {
     ...
     * peers present in the last net.sourceforge.projects.bitext.tracker response
     ...
     * the reason why the last try to contact net.sourceforge.projects.bitext.tracker failed
     * @param error int
