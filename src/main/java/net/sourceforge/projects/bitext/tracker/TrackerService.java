...
public class TrackerService extends Service {
    ...
    private static final String[] MESSAGE = {
                                            "The requested torrent is not listed on this net.sourceforge.projects.bitext.tracker",
                                            ...
                                            "Request failed due to net.sourceforge.projects.bitext.tracker internal error. Try again later",
                                            "Malformed request..."};

    Document peerList;

    /**
     * Default constructor for the net.sourceforge.projects.bitext.tracker service, requested by the Simple server
    ...
    /**
     * Method called when a request is received at the net.sourceforge.projects.bitext.tracker address
    ...
    /**
     * Search if the torrent requested is registered to this net.sourceforge.projects.bitext.tracker
     ...
     * sharing a file and announced to this net.sourceforge.projects.bitext.tracker
     */
    ...
    /**
     * Look if the given torrent is already registered on this net.sourceforge.projects.bitext.tracker
