...
/**
 * Service called to upload a torrent file to the net.sourceforge.projects.bitext.tracker
 *
 * <p>Titre : TrackerBT</p>
 *
...
public class UploadService extends Service {
     ...
     * successful upload, the torrent will be registered on the net.sourceforge.projects.bitext.tracker and freely available
     * for download
    ...
    /**
     * Look if the torrent is already registered on this net.sourceforge.projects.bitext.tracker
     * @param root Root element of the XML document representing the torrent database
     * @param hash Id of the file being uploaded
     * @return boolean true if the file doesn't exist on the net.sourceforge.projects.bitext.tracker, false otherwise
     */
